...
(function (global, factory) {
	...
	*/
	...
	let scrollMax = carouselTrackWidth - carouselTrack.clientWidth; // const resetSize = () => {
	...
	const setActiveDot = (current, target) => {
	  const indexCurrent = carouselItemsArray.findIndex(item => item === current);
	...
	const moveToSlide = (firstSlide, targetSlide) => {
	  ...
	  carouselItems.forEach(item => item.style.transform = `translateX(-${amountToMove}px)`);
	};
